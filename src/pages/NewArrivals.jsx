        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] h-[50px]">
          <div className="absolute inset-0 z-10">
            <svg className="w-[200%] h-full animate-[wave_20s_linear_infinite] opacity-40" viewBox="0 0 1200 120" preserveAspectRatio="none">
              <path d="M0,30 C150,110 350,-10 600,30 C850,70 1050,-10 1200,30 L1200,120 L0,120 Z" fill="#F3EFE0" />
              <path d="M-1200,30 C-1050,110 -850,-10 -600,30 C-350,70 -150,-10 0,30 L0,120 L-1200,120 Z" fill="#F3EFE0" />
            </svg>
          </div>
          <div className="absolute inset-0 z-20">
            <svg className="w-[200%] h-full animate-[wave_15s_linear_infinite] opacity-60" viewBox="0 0 1200 120" preserveAspectRatio="none">
              <path d="M0,40 C200,100 400,0 600,40 C800,80 1000,0 1200,40 L1200,120 L0,120 Z" fill="#EAE3D2" />
              <path d="M-1200,40 C-1000,100 -800,0 -600,40 C-400,80 -200,0 0,40 L0,120 L-1200,120 Z" fill="#EAE3D2" />
            </svg>
          </div>
